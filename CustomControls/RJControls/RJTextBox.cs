...
namespace CustomControls.RJControls
{
    ...
    public partial class RJTextBox : UserControl
    {
        ...
        private void textBox1_GotFocus(object sender, EventArgs e) { this.BackColor = Color.LightYellow; }

        private void textBox1_LostFocus(object sender, EventArgs e) { this.BackColor = colorOriginal; }
